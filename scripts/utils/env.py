...
so = ctypes.CDLL('/home/baifan/Projects/IPM_kinova_push_sim/scripts/utils/search.so')
#so = ctypes.CDLL('/home/baifan/Projects/IPM_kinova_push_sim/scripts/utils/search_low.so')
# so = ctypes.CDLL('/home/baifan/OCRTOC_software_package/IPM_kinova_push_sim/scripts/utils/search.so')
