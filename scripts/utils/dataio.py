...
from utils.env import ENV as classic
from utils.env import ENV_ablation_wo_base as base
from utils.env import ENV_ablation_wo_multi as multi
from utils.env import ENV_ablation_wo_repetition as repetition
...
class DataIO(object):
    ...
    def make_action_logits(self, logits):
        ...
        return rewards, actions, action_log_probs
